...
import {HonestWeekInterface} from "../../Types/interfaces";

export const HonestWeekPicker = ({ onChange, startValue } : any ) => {
    const [open, setOpen] = useState<boolean>(false);
    const [date, setDate] = useState<Date>(new Date());
    const [week, setWeek] = useState<HonestWeekInterface>(startValue as HonestWeekInterface);
