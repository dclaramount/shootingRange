...
export function WrapperManagementDashboard ( apiPayload: ManagementPluginPayload ) {
  ...
  /*-------------------------------------------------------------------------------------------------------------*/
  const [globalVariabes, setGlobalVariables] = React.useState<globalVariablesType>( gVariables );
  const [refreshManagementDashboard, setRefreshManagementDashboard] = React.useState( new Date() );
  const [tabSelector, setTabSelector] = React.useState<number>( 0 );
