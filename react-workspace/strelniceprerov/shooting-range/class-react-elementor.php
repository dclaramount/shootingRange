...
/**
 * Main Elementor shooting-range Class
 *
 * The init class that runs the Elementor shooting-range plugin.
...
final class SHOOTING_RANGE {
    ...
    public function i18n() {
        load_plugin_textdomain( 'shooting-range' );
    }
    ...
    public function admin_notice_missing_main_plugin() {
        deactivate_plugins( plugin_basename( SHOOTING_RANGE ) );
