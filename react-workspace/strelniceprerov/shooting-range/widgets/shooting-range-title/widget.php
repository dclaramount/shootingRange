 ...
 * @since 1.0.0
 */
class SHOOTING_RANGE_TITLE extends Widget_Base
{
    /**
     * Class constructor.
     *
    ...
    {
        return __('shooting-range-title', 'elementor-shooting-range');
    }
    ...
    protected function _register_controls()
    {
        $this->start_controls_section(
            ...
            $this->add_control(
                'label',
                array(
                    'label' => __('label label', 'elementor-shooting-range'),
                    'type' => Controls_Manager::TEXT,
                    'default' => __('My cool label', 'elementor-shooting-range'),
                )
            );
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute(
            'shooting-range-title-wrapper',
            [
                 
                     'label' => wp_kses( $settings['label'], array() ),
    ...
    protected function _content_template()
    {
        ...
        <shooting-range-title {{{ view.getRenderAttributeString( 'shooting-range-title-wrapper' ) }}}></shooting-range-title>
        <?php
    }
}
