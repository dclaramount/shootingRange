...
export type ShootingRangeTitleProps = InferProps<typeof ShootingRangeTitlePropsTypes>;
...
export function ShootingRangeTitle(props: ShootingRangeTitleProps) {
  ...
  /********************************************************************************************************************************/
  /* FETCH THE GLOBAL VARIABLES TO KICK START MY CONTEXT PROVIDER VALUES */
  /********************************************************************************************************************************/
  React.useEffect(() =>{    
    axios({
      url:      URL,
  ...
  /********************************************************************************************************************************/
  /* ARTIFICIAL DELAY TO SHOW THE LOADING BANNER */
  /********************************************************************************************************************************/
  ...
  return (
      <div className="wrapper-diego">
        {(Object.keys(globalVariables).length > 0 && waitDone) ? <WrapperBooking gVariables={globalVariables}/> : <div style={{ height:'882px', backgroundColor:'white', border: '1px solid transparent', borderRadius:'20px'}}><TextPlaceholder text={Translations.LoadingPlaceholder}/></div>}
        <div id="popup-root" />
      </div>
  )
};
