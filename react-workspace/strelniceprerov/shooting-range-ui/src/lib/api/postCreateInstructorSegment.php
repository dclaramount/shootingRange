...
while($startDealBreaker < $endDealBreaker) {
  ...
  $query = "SELECT * from instructor_segments WHERE instructor_id='$instructorId' AND start_time='$startStrDealBreaker' AND end_time='$endStrDealBreaker' AND isDeleted=false;"; 
